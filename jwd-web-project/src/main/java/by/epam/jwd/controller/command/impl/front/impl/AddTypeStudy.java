...
private static Logger logger = LogManager.getLogger();
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (flag) {
				session.setAttribute(SessionParameter.SUCCESS_ADD_TYPE, SessionParameter.SUCCESS_ADD_TYPE);
			} else {
				session.setAttribute(SessionParameter.UNSUCCESS_ADD_TYPE, SessionParameter.UNSUCCESS_ADD_TYPE);	
			}

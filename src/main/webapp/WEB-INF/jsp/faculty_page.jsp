...
<html>
	<head>
		...
		<fmt:message bundle="${loc}" key="local.admin_message.unsuccess_remove_faculty" var="unsuccess_remove_faculty_message" />
		<fmt:message bundle="${loc}" key="local.admin_message.success_remove_faculty" var="success_remove_faculty_message" />
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 order-md-1">
					...
					<c:if test="${not empty unsuccess_remove_faculty}">
						<div class="alert alert-danger" role="alert">
							<c:out value="${unsuccess_remove_faculty_message}"></c:out>
						</div>
					</c:if>
					<c:if test="${not empty success_remove_faculty}">
						<div class="alert alert-success" role="alert">
							<c:out value="${success_remove_faculty_message}"></c:out>
						</div>
					</c:if>

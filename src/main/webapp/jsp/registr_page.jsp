...
<html>
	<head>
		...
		<fmt:message bundle="${loc}" key="local.message.email_already_exist" var="email_already_exist_message" />
	</head>
	<body class="text-center">		
		<div class="form-signin">	
			...
			<c:if test="${not empty email_already_exist}">
				<div class="alert alert-warning" role="alert">
					<c:out value="${email_already_exist_message}"></c:out>
				</div>
			</c:if>	

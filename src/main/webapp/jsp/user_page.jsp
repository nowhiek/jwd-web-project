						...
						<h2 class="mb-3 mt-3">Profile</h2>
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									...
									<input type="text" class="form-control" id="firstName" value="${user_detail.getFirstName()}" name="first_name"/>				
								</div>
								<div class="col-md-6 mb-3">
									<label for="lastName">${second_name_label}:</label>
									<input type="text" class="form-control" id="lastName" value="${user_detail.getSecondName()}" name="second_name"/>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-2 mb-3">
									...
									<input type="text" class="form-control" id="serialPassport" value="${user_detail.getSerialPassport()}" name="serial_passport">
								</div>
								<div class="col-md-4 mb-3">
									<label for="numberPassport">${number_passport_label}:</label>
									<input type="number" min="0" max="9999999" class="form-control" id="number_passport_label" value="${user_detail.getNumberPassport()}" name="number_passport">
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									...
									<input type="date" class="form-control" id="dateBirthday" value="${user_detail.getBirthday()}" name="birthday"/>
								</div>
								<div class="col-md-3 mb-3">
									<input type="hidden">
								</div>
